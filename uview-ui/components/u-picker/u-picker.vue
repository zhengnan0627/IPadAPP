<template>
	<u-popup :maskCloseAble="maskCloseAble" mode="right" :popup="false" v-model="value" length="60%" :safeAreaInsetBottom="safeAreaInsetBottom" @close="close" :z-index="uZIndex">
